...
/// Controls the launchd agent that `rename install` registered.
/// We do NOT touch the .plist — only load/unload it.
struct LaunchctlBridge {
    static let plistPath = ("~/Library/LaunchAgents/com.github.rename.plist" as NSString)
