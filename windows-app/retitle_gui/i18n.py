...
at startup; users can override with the ``RETITLE_GUI_LANG`` env var
(``en`` or ``zh-Hans``).
"""
...
_STRINGS = {
    # status
    "running": {"en": "retitle is running", "zh-Hans": "retitle 运行中"},
    "running_sub": {
    ...
    "no_daemon_sub": {
        "en": "Run `retitle install` (Linux/macOS) or just keep this app open "
              "to keep renaming in the foreground.",
        "zh-Hans": "可以跑一次 `retitle install`(Linux/macOS),或者就开着这个 app,"
                   "让它在前台跑改名。",
    },
    "loading": {"en": "Loading…", "zh-Hans": "加载中…"},
    "cli_not_found": {
        "en": "retitle CLI not found. Install with: pipx install retitle",
        "zh-Hans": "找不到 retitle 命令。请用 pipx install retitle 安装。",
    },
    ...
    "quit": {"en": "Quit Retitle", "zh-Hans": "退出 Retitle"},
    # dashboard
    ...
    # settings
    "settings_title": {"en": "Retitle Settings", "zh-Hans": "Retitle 设置"},
...
def detect_lang() -> str:
    override = os.environ.get("RETITLE_GUI_LANG")
