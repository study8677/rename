...
from .bridge import DaemonControl, RenameCLI, RenameError, find_rename
from .i18n import t
...
class AppState(QObject):
    ...
    def __init__(self, cli: RenameCLI | None) -> None:
        super().__init__()
        self.cli = cli
    ...
    def toast(self, level: str, message: str) -> None:
        ...
        if not (self._dashboard and self._dashboard.isVisible()):
            ...
            if isinstance(tray, QSystemTrayIcon):
                ...
                tray.showMessage("Rename", message, icon_kind, 3500)
