...
[简体中文](README.md) · **English** · [Cookbook](docs/COOKBOOK.md)
...
No API key required. Zero runtime dependencies. Works on macOS, Linux, and Windows.
...
| `rename install` | Install + start the background service (launchd on macOS, systemd on Linux, a Startup shortcut on Windows) |
